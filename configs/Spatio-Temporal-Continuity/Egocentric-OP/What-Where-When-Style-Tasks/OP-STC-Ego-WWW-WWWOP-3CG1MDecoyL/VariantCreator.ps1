$MasterYAML = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-Random-*.yml'
...
$ColourVariantList = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*.yml'
foreach ($row in $ColourVariantList){
$copyto = $row.FullName -replace "-0-","-180-"
Copy-Item $row.FullName $copyto}

Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceMDecoyL\*-180-*.yml' | ForEach {
