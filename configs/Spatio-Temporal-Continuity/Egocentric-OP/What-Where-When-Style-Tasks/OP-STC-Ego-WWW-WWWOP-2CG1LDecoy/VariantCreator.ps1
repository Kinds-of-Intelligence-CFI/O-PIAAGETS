$MasterYAML = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-Random-*.yml'
...
$ColourVariantList = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*.yml'
foreach ($row in $ColourVariantList){
$copyto = $row.FullName -replace "-0-","-180-"
Copy-Item $row.FullName $copyto}

Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceLDecoy\*-180-*.yml' | ForEach {
