$MasterYAML = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-Random-*.yml'
...
$ColourVariantList = Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*.yml'
foreach ($row in $ColourVariantList){
$copyto = $row.FullName -replace "-0-","-180-"
Copy-Item $row.FullName $copyto}

Get-ChildItem '.\OP-STC-Ego-RAM-SeqRightForced-1BigLL5SETR\*-180-*.yml' | ForEach {
