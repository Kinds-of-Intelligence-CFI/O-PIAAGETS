$MasterYAML = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-Random-*.yml'
...
$ColourVariantList = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*.yml'
foreach ($row in $ColourVariantList){
$copyto = $row.FullName -replace "-0-","-180-"
Copy-Item $row.FullName $copyto}

Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-3ChoiceLDecoyR\*-180-*.yml' | ForEach {
