$MasterYAML = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-RAM-8ArmRAMRight-LeftTopForced\*-Random-*.yml'
