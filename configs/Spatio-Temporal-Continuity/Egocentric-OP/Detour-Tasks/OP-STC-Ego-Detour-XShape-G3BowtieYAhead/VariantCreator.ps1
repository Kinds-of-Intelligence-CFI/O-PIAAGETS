$MasterYAML = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-Random-*.yml'
...
$ColourVariantList = Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*.yml'
foreach ($row in $ColourVariantList){
$copyto = $row.FullName -replace "-0-","-180-"
Copy-Item $row.FullName $copyto}

Get-ChildItem '.\OP-STC-Ego-Detour-Xshape-BowtieYAhead\*-180-*.yml' | ForEach {
