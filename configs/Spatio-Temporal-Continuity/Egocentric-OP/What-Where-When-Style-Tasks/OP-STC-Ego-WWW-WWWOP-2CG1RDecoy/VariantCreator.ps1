$MasterYAML = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*.yml'

$copyto = $MasterYAML.FullName -replace "-Grey-","-DarkGreen-"
Copy-Item $MasterYAML.FullName $copyto
$DarkGreenVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-DarkGreen-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BeigeVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-Beige-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$OffwhiteVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-Off-white-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$DarkBlueVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-DarkBlue-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$BrownVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-Brown-*.yml'
...
Copy-Item $MasterYAML.FullName $copyto
$RandomVariant = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-Random-*.yml'
...
$ColourVariantList = Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*.yml'
foreach ($row in $ColourVariantList){
$copyto = $row.FullName -replace "-0-","-180-"
Copy-Item $row.FullName $copyto}

Get-ChildItem '.\OP-STC-Ego-WWW-WWWOP-2ChoiceRDecoy\*-180-*.yml' | ForEach {
